...
contract FPTPSimulation {
    ...
    /// *** UNLIMITED VOTE SIZE ALLOWED FOR ELECTION SIMULATON PURPOSES ***
    /// @notice Cast a vote
    /// @param candidateName The name (bytes32) of the candidate that the voter intends to vote for
    function castVote(bytes32 candidateName, uint sizeOfVote)
        external
        electionHasStarted
        electionHasNotEnded
        ...
        returns (bool)
    {
        ...
        // Add the voters vote
        /// *** UNLIMITED VOTE SIZE ALLOWED FOR ELECTION SIMULATON PURPOSES ***
        constituency.candidates[candidateIndex].votes += sizeOfVote;
