...
describe("First Past the Post Amend - Add Constituency", function () {
...
describe("First Past the Post Amend - Add Constituency Candidate", function () {
    // Test constituency name
    const constituencyName = ethers.encodeBytes32String("Test Constituency");
...
describe("First Past the Post Amend - Add Voter", function () {
    // Test constituency name
    const constituencyName = ethers.encodeBytes32String("Test Constituency");
...
describe("First Past the Post Amend - Cast Vote", function () {
    // Test constituency name
    const constituencyName = ethers.encodeBytes32String("Test Constituency");
    ...
    it("Voter can ammend thier vote", async function () {
        // Candidate the voter will vote for
        let voteCandidate = ethers.encodeBytes32String("Test Candidate1");
        ...
        // New candidate the voter will vote for
        voteCandidate = ethers.encodeBytes32String("Test Candidate2");
...
describe("First Past the Post Amend - Start Election", function () {
    beforeEach(async function () {
        [admin, voter] = await ethers.getSigners();
...
describe("First Past the Post Amend - End Election", function () {
    beforeEach(async function () {
        [admin, voter] = await ethers.getSigners();
...
describe("First Past the Post Amend - Calculate Election Results", function () {
    beforeEach(async function () {
    ...
    it("Should correctly calculate the winner in an election with multiple constituencies", async function () {
        ...
        expect(eventLog[2].args[0]).to.equal(ethers.encodeBytes32String("Harrogate"))
        expect(eventLog[2].args[1]).to.equal(ethers.encodeBytes32String("Jim"))
        ...
        expect(eventLog[3].args[0]).to.equal(ethers.encodeBytes32String("Knaresborough"))
        expect(eventLog[3].args[1]).to.equal(ethers.encodeBytes32String("Steve"))
        expect(eventLog[3].args[2]).to.equal(ethers.encodeBytes32String("Conservatives"))
        
        // York Constituency Winner Event
        expect(eventLog[4].fragment.name).to.equal("ConstituencyWinner")
        expect(eventLog[4].args[0]).to.equal(ethers.encodeBytes32String("York"))
        expect(eventLog[4].args[1]).to.equal(ethers.encodeBytes32String("Garry"))
        expect(eventLog[4].args[2]).to.equal(ethers.encodeBytes32String("Labour"))

        // Leeds Constituency Winner Event
        expect(eventLog[5].fragment.name).to.equal("ConstituencyWinner")
        expect(eventLog[5].args[0]).to.equal(ethers.encodeBytes32String("Leeds"))
        expect(eventLog[5].args[1]).to.equal(ethers.encodeBytes32String("Jake"))
        expect(eventLog[5].args[2]).to.equal(ethers.encodeBytes32String("Reform"))

        // All Constituency Winners Calculated Event
        expect(eventLog[6].fragment.name).to.equal("AllConstituencyWinnersCalculated")

        // Election Results Calculated Event
        expect(eventLog[7].fragment.name).to.equal("ElectionResultsCalculated")

        // Conservative Party Results Event
        expect(eventLog[8].fragment.name).to.equal("PartyResults")
        expect(eventLog[8].args[0]).to.equal(ethers.encodeBytes32String("Conservatives"))
        expect(eventLog[8].args[1]).to.equal(2)
        
        // Labour Party Results Event
        expect(eventLog[9].fragment.name).to.equal("PartyResults")
        expect(eventLog[9].args[0]).to.equal(ethers.encodeBytes32String("Labour"))
        expect(eventLog[9].args[1]).to.equal(1)

        // Reform Party Results Event
        expect(eventLog[10].fragment.name).to.equal("PartyResults")
        expect(eventLog[10].args[0]).to.equal(ethers.encodeBytes32String("Reform"))
        expect(eventLog[10].args[1]).to.equal(1)

        // Election Winner Event
        expect(eventLog[11].fragment.name).to.equal("ElectionWinner")
        expect(eventLog[11].args[0]).to.equal(ethers.encodeBytes32String("Conservatives"))
        expect(eventLog[11].args[1]).to.equal(2)
    })
})
...
describe.skip("First Past the Post Amend - Simulate an Aberafan Maesteg constituency election", function () {
...
describe.skip("First Past the Post Amend - Simulate an Aberafan Maesteg constituency election with vote changes", function () {
    let constituencyData;
    ...
    it("Simulate an Aberafan Maesteg constituency election vote", async function () {
        ...
        // Cast meaningless votes to be ammended later
        for (let i = 0; i < candidateNames.length; i++) {
            candidateVotes = constiteuncyVotes[i]
            candidateName = candidateNames[i]
