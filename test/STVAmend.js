...
describe("Single Transferable Vote Amend - Add Constituency", function () {
...
describe("Single Transferable Vote Amend - Add Constituency Candidate", function () {
    // Test constituency name
    const constituencyName = ethers.encodeBytes32String("Test Constituency");
...
describe("Single Transferable Vote Amend - Add Voter", function () {
    // Test constituency name
    const constituencyName = ethers.encodeBytes32String("Test Constituency");
    // Test constituency number of seats available for election
    const numberOfSeats = 5;
...
describe("Single Transferable Vote Amend - Cast Vote", function () {
    // Test constituency name
    const constituencyName = ethers.encodeBytes32String("Test Constituency");
    ...
    it("Voter can ammend their vote", async function () {
        // Test candidate ranking
        let candidateRanking = [candidateName1, candidateName2, candidateName3];
        ...
        // New Test candidate ranking
        candidateRanking = [candidateName2, candidateName1, candidateName3];
...
describe("Single Transferable Vote Amend - Start Election", function () {
    beforeEach(async function () {
        [admin, voter] = await ethers.getSigners();
...
describe("Single Transferable Vote Amend - End Election", function () {
    beforeEach(async function () {
        [admin, voter] = await ethers.getSigners();
