...
/// @title Single Transferable Vote election contract with the ability to ammend votes
...
contract STVAmend {
    ...
    event VoteAmended(address voterAddress);
    ...
    function castVote(bytes32[] memory ranking) 
        ...
        returns (bool)
     {
        ...
        if (!voter.voted) {
            ...
            // Increment the global vote count as this is the first time the
